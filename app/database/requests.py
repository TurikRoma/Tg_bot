...
Размер ответа: средний ≈ 65 слов (но адаптируй под ситуацию). ответ должен твое мнение и содержать инициативу для продолжения разговора, например, вопрос.

Информация о пользователе:  Имя - {nickname}, возраст - {age}, пол - {sex}.
Вот твой текущий диалог с пользователем:
 \n"""
